...
\left\lbrace
	\begin{array}{rcl}
	\sin^2(\varphi) & \simeq & 0.0768 - 7.0910\,10^{-5} \deltaLiOut + \left(2.5586\,10^{-4}\deltaLiOut\right)^2\\
	\cos^2(\varphi) & \simeq & 0.9232 + 7.0910\,10^{-5} \deltaLiOut - \left(2.5586\,10^{-4}\deltaLiOut\right)^2\\
	\end{array}
\right.
\end{equation}
...
\begin{array}{rcl}
 ...
 \\
 \kappa & = & \dfrac{\bar{p}^2 \proton E_0}{\delta^\ast} = \dfrac{\bar{p}^2 \proton E_0}{1+\tilde{J}\LiOut{}}\\
 \\
