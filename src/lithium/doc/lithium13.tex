...
\begin{array}{rcll}
	...
	\partial_t\Li{x} & = & \left\lbrack k_x^l\Theta'_x+\omega_x E_0\right\rbrack
		...
		\right\rbrack & \\
	\beta & = & \Theta + \kappa_h \left(1-\alpha_\infty\right) & \kappa = \dfrac{\bar{p}^2 \proton E_0}{1+J_6\LiOut{6}+J_7\LiOut{7}} \\
	\end{array}
\right.
\end{equation}
and using
...
\begin{array}{rcl}
	...
	\left[
	 ...
	 \\
	 \sigma_x & = & \dfrac{\omega_x}{k_x^l} = \bar{p}^2\proton \dfrac{\LiOut{x}}{1+J_6\LiOut{6}+J_7\LiOut{7}} \\
	 \\
