...
\left\lbrace
	\begin{array}{rcl}
		...
		\partial_t\Li{x} & = & \left\lbrack k_x\tilde{\Theta}_x+\Upsilon_0 h  E_0\right\rbrack
		-\left\lbrack
			\Upsilon_0 h  E_0\alpha +  \Li{x}  \left(k_x + k_x^q E_0\alpha\right)
		\right\rbrack\\
	\end{array}
\right.
}
...
\begin{equation}
	\Li{x}_\infty = \dfrac{\left\lbrack k_x\tilde{\Theta}_x+\Upsilon_0 h_\infty E_0 \left(1-\alpha_\infty\right)\right\rbrack}{k_x+ k_x^q E_0\alpha_\infty}
\end{equation}
