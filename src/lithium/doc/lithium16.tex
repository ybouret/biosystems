...
\begin{array}{ccl}
	...
	\\
	A_x & = & \dfrac{h_0\Upsilon_x}{k_x} = \dfrac{\dfrac{k_x^p J_x}{k_x} \epsilon_x  E_0 h_0}{1+\left(\sum_x J_x \epsilon_x \right) \LiAllOut} = \epsilon_x \dfrac{\bar{p}_x^2}{1+J_\epsilon \LiAllOut} h_0 E_0 \\
	\\
...
\begin{equation}
	...
	{\left( \Theta + A_6\cos^2\phi \right)  \left[1-e^{-\tau}\right]+ A_6B(\Omega,\tau) \sin^2\phi }
\end{equation}
