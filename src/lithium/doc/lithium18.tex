...
\begin{equation}
	g(\tau) = 1+\Upsilon_\alpha h(\tau), \;\; \ig(\tau) = \int_0^\tau g(u) \, \mathrm{d} u
\end{equation}
...
\begin{equation}
	\hat\alpha_1(\tau) = {\hat\alpha_1^\infty + \left(1-\hat\alpha_1^\infty\right) e^{-\Omega \tau} },\;\;\Omega=1+h_0\Upsilon_\alpha
\end{equation}
...
\left\lbrace
\begin{array}{rcl}
\beta_x(\tau) & = & \displaystyle \left[ \int_0^\tau \left( \mu_x \Theta + \eta \hat\alpha(u) h(u) \Upsilon_x \right)e^{\mu_x u} \, \mathrm{d} u \right] e^{-\mu_x\tau}\\
\\
