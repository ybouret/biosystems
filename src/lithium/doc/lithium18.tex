...
\begin{array}{rcl}
	...
	+ \left(\Omega-1\right) B\left(\frac{\Omega}{\mu_x},\tau\right)
	 \right]
	\\
\end{array}
\right.
...
+ \dfrac{\eta}{\mu_x}  \cos^2 \varphi_x  \; \cos^2\theta \left[  \left[ 1-e^{-\mu_x \tau}\right] + \tan^2\theta \; B\left(\frac{1}{\mu_x\cos^2\theta},\mu_x \tau)\right)\right]
\end{equation}
