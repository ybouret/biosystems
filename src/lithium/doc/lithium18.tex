...
\begin{array}{rcl}
	...
	\right]\\
	\\
	& = & \displaystyle \Theta \left[ 1-e^{-\mu_x \tau}\right] + \dfrac{\eta}{\mu_x} h_0 \Upsilon_x 
	\left[
	\hat\alpha_1^\infty  \left[ 1-e^{-\mu_x \tau}\right] 
	+
	(1-\hat\alpha_1^\infty) \dfrac{e^{-\frac{\Omega}{\mu_x}\mu_x\tau}-e^{-\mu_x\tau}}{1-\frac{\Omega}{\mu_x}}
	\right]
	\\
	\\
	& = & 
	\displaystyle \Theta \left[ 1-e^{-\mu_x \tau}\right] 
	+ \dfrac{\eta}{\mu_x} \dfrac{h_0\Upsilon_x}{\Omega}
	\left[
	\left[ 1-e^{-\mu_x \tau}\right] 
	+ \left(\Omega-1\right) B\left(\frac{\Omega}{\mu_x},\mu_x\tau\right)
	 \right]
	\\
\end{array}
\right.
...
\begin{array}{rcl}
	...
	h_0 \Upsilon_x & = & \cos^2 \varphi_x \, \tan^2\theta\\
	\cos^2 \varphi_x & = & \dfrac{\Upsilon_x}{\epsilon\Upsilon_6+(1-\epsilon)\Upsilon_7} \\
\end{array}
\right.
\end{equation}
so that
\begin{equation}
\beta_{x,0}(\tau) = \Theta \left[ 1-e^{-\mu_x \tau}\right]
+ \dfrac{\eta}{\mu_x}  \cos^2 \varphi_x  \; \sin^2\theta \left[  \left[ 1-e^{-\mu_x \tau}\right] + \tan^2\theta \; B\left(\frac{1}{\mu_x\cos^2\theta},\mu_x \tau)\right)\right]
\end{equation}
