...
\partial_t \beta_x  & = &  k_x \left(\Theta -\beta_x \right) + \eta \hat\alpha \dfrac{ k_x^p J_x}{\tilde{D}} \LiAllOut \proton\\
 %\eta \left[ \hat\alpha \dfrac{ k_x^p J_x}{\tilde{D}} \LiAllOut \proton  -  \left(1-\hat\alpha\right) \LiAllOut k_x^q \beta_x \right] \\
\\
...
% \eta \left[ \hat\alpha \proton \Upsilon_x  -  \left(1-\hat\alpha\right) Q_x\beta_x \right] \\
\\
...
%\subsubsection{Single Secondary Separation Speedup Hypothesis !!FALSE!!}
%
...
%	k_6          & = & \sigma k_7\\
%	\mu_6        & = & \sigma \mu_7\\
%	\Upsilon_6   & \propto & k_6^p J_6 = k_6^p k_6^a/k_6^d \propto \sigma \Upsilon_7\\
%	\rho_6       & = & \sigma \rho_7\\
