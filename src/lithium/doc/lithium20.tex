...
So that
\begin{equation}
	\beta_x = \Theta + \eta \dfrac{h_\infty\Upsilon_x\cos^2\Omega}{\mu_x} \cos^2 B_x,\;\;Q_x\to0\text{ when }B_x\to0
\end{equation}
and we notice
\begin{equation}
...
We can write
\begin{equation}
	\beta_x^\infty = \Theta \left(1 + f_0 \dfrac{h_\infty}{h_0} \dfrac{\Upsilon_x}{\Upsilon_7}\dfrac{\mu_7}{\mu_x}\cos^2 \Omega\cos^2 B_x\right)
...
so that
\begin{equation}
	\beta_7^\infty = \Theta \left(1 + f_0 \dfrac{h_\infty}{h_0} 
	\dfrac{\cos^2 B_7}{1+\left[\epsilon\kappa+(1-\kappa)\right] h_\infty \Upsilon_7 }
	\right)
\end{equation}

\begin{equation}
	\beta_6^\infty = \Theta \left(1 + f_0 \dfrac{h_\infty}{h_0} \dfrac{\kappa}{\sigma}
	\dfrac{\cos^2 B_6}{1+\left[\epsilon\kappa+(1-\kappa)\right] h_\infty \Upsilon_7 }
	\right)
\end{equation}
...
\begin{array}{rcl}
 ...
 \left(\cos^2\Omega \cos^2\psi + \sin^2\psi\right) \left(\sum_x \epsilon_x h_\infty \Upsilon_x\right) - \cos^2 \Omega \left(\sum_x \epsilon_x h_\infty \Upsilon_x \cos^2 B_x \right)\\
 \\
\sin^2\Omega  \cos^2\psi \dfrac{\tan^2\psi}{\cos^2\Omega} & = & \left(\cos^2\Omega \cos^2\psi + \sin^2\psi\right) \tan^2 \Omega
 - \cos^2 \Omega \left(\sum_x \epsilon_x h_\infty \Upsilon_x \cos^2 B_x \right)\\
 \\
 \cos^2\psi & = & \dfrac{\sum_x \epsilon_x \Upsilon_x \cos^2 B_x }{\sum_x \epsilon_x \Upsilon_x} 
 = \dfrac{\epsilon\kappa\cos^2B_6+(1-\epsilon)\cos^2B_7}{\epsilon\kappa+(1-\epsilon)}\\
 \\
  & \in &  \left[\min\left(\cos^2B_6,\cos^2B_7\right):\max\left(\cos^2B_6,\cos^2B_7\right)\right] \\
\end{array}
\right.
\end{equation}
