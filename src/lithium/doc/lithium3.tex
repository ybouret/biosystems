...
and
\begin{equation}
\delta_x = k_d^x k_r^x + k_p^x \Hin \left(k_f^x+k_d^x\right) = \Pi_{dr}^x + \Hin \left( \Pi_{fp}^x + \Pi_{dp}^x \right)
\end{equation}
We write
\begin{equation}
	\begin{pmatrix}
...
\begin{equation}
	\mytrn{\vec{\sigma}} S_6 =
	\begin{pmatrix}
	\left(k_f^6+k_r^6 + k_p^6 \Hin \right) & \left(k_f^6+k_r^6 + k_d^6\right)\\
	\end{pmatrix}
\end{equation}
