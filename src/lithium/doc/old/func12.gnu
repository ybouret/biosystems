...
peak_max(sigma)     = sigma**(-sigma/(sigma-1.0));

peak_pol(x,sigma)   = x - (1.0+sigma)/2.0*x*x + (1.0+sigma+sigma**2)/6.0*x**3 - (1.0+sigma+sigma**2+sigma**3)/24.0*x**4;
...
Omega(tau,phi6,gam7,sigma) = gam7 * (phi6*peak(tau,sigma))/intake(tau,phi6,sigma);
