...
\left\lbrace
\begin{array}{rcl}
	\partial_t \myconc{X_u}  & = & \dfrac{k^p_u J_uC_u}{1+J_1C_1+J_2C_2} \left(\mathcal{E}-E_{0H}\right) \proton + k_u \left( e^{\dfrac{-z_u F V_m }{RT}} C_u - \myconc{\spx_u}\right) \\
	\\
...
\left\lbrace
\begin{array}{rcl}
	\partial_t \beta_u & = & \mathcal{E} \left[\dfrac{k^p_u J_u}{1+J_0 C_0}\right] \left(1-\alpha\right) \proton
