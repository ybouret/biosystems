...
\begin{equation}
	...
	{
	\mathfrak{E} \left[\dfrac{k^p_v J_v}{1+J_0 C_0}\right] \proton_0 + k_v  \Theta_v
	}
\end{equation}
...
\begin{array}{rcll}
	...
	\\
	\\
	\partial_t \myconc{\spx_2} & = & <\vec{C}|\mymat{G}_2|\vec{E}_1> + k_1\left(\Theta C_2 - \myconc{\spx_1}\right), &
	\mymat{G}_2 = 
	\begin{bmatrix}
	0              & f_{21} k^p_{21}\\
