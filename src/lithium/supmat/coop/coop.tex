...
We define the first layer variables as
\begin{equation}
...
\left\lbrace
\begin{array}{rcll}
	\partial_t \Li{6} & = & <\vec{C}|\mymat{G}_6|\vec{E}_1> + k_6\left(\Theta \LiOut{6} - \Li{6}\right), &
	\mymat{G}_6 = 
	\begin{bmatrix}
	...
	\\
	\\
	\partial_t \Li{7} & = & <\vec{C}|\mymat{G}_7|\vec{E}_1> + k_1\left(\Theta \LiOut{6} - \Li{6}\right), &
	\mymat{G}_2 = 
	\begin{bmatrix}
	0              & f_{76} k^p_{76}\\
