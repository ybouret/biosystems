...
\left\lbrace
\begin{array}{rcl}
W_1 & = & 1 +  <\vec{L}_1| \mymat{\Delta}_K \mymat{D}_0 | \vec{C}> \\
\\
...
& = & W_1 E_{00} + < \vec{L}_1 + \mytrn{\mymat{F}}\vec{C} | \mymat{M}_1 \left( 
	\mymat{R}_H \vec{E}_H + E_{00} \mymat{A}_0 \vec{C}\right) > + <W_1 \vec{L}_1|\vec{E}_H> \\
	& = & E_{00} \left(W_1 + < \vec{L}_1 + \mytrn{\mymat{F}}\vec{C}| \mymat{M}_1 \mymat{A}_0 |\vec{C} >\right) +
	\left( <W_1\vec{L}_1|\vec{E}_H> + < \vec{L}_1 + \mytrn{\mymat{F}}\vec{C}| \mymat{M}_1 \mymat{R}_H | \vec{E}_H> \right) \\
\end{array}
\right.
\end{equation}
\end{document}
