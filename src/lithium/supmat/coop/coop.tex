...
\left\lbrace
\begin{array}{rcl}
	\widetilde{\mathsf{N}}_7(\LiAllOut) & = & \underbrace{i_7 u_7}_{v_7} \left[ \left(u_7\LiAllOut\right) + \dfrac{1}{2} \left(u_7\LiAllOut\right)^2\right]\\
	\\
...
and we obtain:
\begin{equation}
	\dfrac{\widetilde{\mathsf{N}}_7(\LiAllOut)}{1+\widetilde{\mathsf{D}}(\LiAllOut)} = \dfrac{X}{1+X+X^2},\;\; X=C_0u_7
\end{equation}
