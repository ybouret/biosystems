...
But if we evaluate:
\begin{equation}
	\left.\dfrac{\beta_7}{\beta_7}\right\vert_\varnothing = 
	\dfrac{ \dfrac{\mathsf{N}_7(\LiAllOut)}{1+\mathsf{D}(\LiAllOut)}+k_7 \Theta}
	{  \dfrac{\mathsf{N}_6(\LiAllOut)}{1+\mathsf{D}(\LiAllOut)} +k_6 \Theta}
\end{equation}
where
\begin{itemize}
...
\begin{equation}
	...
	\vec{L}_3 = u_7 \begin{bmatrix} \kappa \\ 1 \\ \end{bmatrix},\;\;
	\mymat{Q}_3 = u_7^2 
	\begin{bmatrix}
