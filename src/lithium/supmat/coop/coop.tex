...
\begin{equation}
\boxed{
E_{xy} = <{\vec{C}} \vert \mymat{F_{xy}^h} \vert \vec{E}_1 > 
}
\end{equation}
with
\begin{equation}
...
\begin{equation}
E_{66} + E_{67} + E_{77} = <{\vec{C}} \vert \mymat{F}_h \vert \vec{E}_1 >, \;\;
 \mymat{F} 
 =  \mymat{F}_{66}^h + \mymat{F}_{67}^h  + \mymat{F}_{77}^h
\end{equation}
and
...
\left\lbrace
\begin{array}{rcl}
	\partial_t \Li{6} & = & <\vec{C}|\mymat{G}_6^h|\vec{E}_1> \proton+ k_6\left(\Theta \LiOut{6} - \Li{6}\right)\\
	\mymat{G}_6^h &= & k^p_{66} \mymat{F}_{66}^h + k^p_{67}\mymat{F}_{67}^h	\\
	\\
	\partial_t \Li{7} & = & <\vec{C}|\mymat{G}_7^h|\vec{E}_1> \proton + k_7\left(\Theta \LiOut{7} - \Li{7}\right)\\
	\mymat{G}_7^h & = & k^p_{77} \mymat{F}_{77}^h + k^p_{76}\mymat{F}_{67}^h \\
\end{array}
\right.
\end{equation}
