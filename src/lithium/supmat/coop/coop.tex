...
\begin{bmatrix}
	...
	DU      & 1\\
\end{bmatrix}
= \dfrac{i_7 u_7^3}{1+D} \vec{L} \mytrn{\vec{L}},\;\; \mymat{Q_6} = U \mymat{Q}_7
\end{equation}
so that
\begin{equation}
\left\lbrace
...
\end{bmatrix}\\
\\
T_d & = & C_7^3 + (1+D)[C_7^2(UC_6)+C_7(UC_6)^2] + D (UC_6)^3 \\
\end{array}
\right.
\end{equation}
we get
