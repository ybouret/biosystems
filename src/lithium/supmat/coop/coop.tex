...
\boxed{
	...
	{ W_1+\underbrace{<\vec{P_1} + \mytrn{\mymat{F}} \vec{C}| \left( \mymat{D}_0^{-1} \mymat{M}_1' \mymat{A}_0 \right) | \vec{C}>}_{W_0}}
}
\end{equation}
In particular
\begin{equation}
...
\left\lbrace
\begin{array}{rcl}
	W_1 \vec{E}_1^\varnothing & = & E_{00}^\varnothing \left(\mymat{D}_0^{-1} \mymat{M}_1' \mymat{A}_0\right) \vec{C}\\
	\\
	\vec{E}_1^\varnothing     & = & \dfrac{\mathsf{E}}{W_1+W_0}\left(\mymat{D}_0^{-1} \mymat{M}_1' \mymat{A}_0\right) \vec{C}\\
\end{array}
\right.
\end{equation}
