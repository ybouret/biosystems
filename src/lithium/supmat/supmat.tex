...
\left\lbrace
\begin{array}{rcl}
	\partial_t \hat\alpha & = & f(t)(1-\hat\alpha) - g(t)\hat\alpha = f(t) - [f(t)+g(t)]\hat\alpha\\
...
then
\begin{equation}
	\partial_t \hat\alpha = \left( 1 + \int_0^t f(u) e^{\left[F(u)+G(u)\right]} \,\mathrm{d}u \right) e^{-\left[F(t)+G(t)\right]}
\end{equation}
We assume now that:
\begin{equation}
\left\lbrace
