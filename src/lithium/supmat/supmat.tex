...
\begin{array}{rcl}
k_h & = & k_0 \eta(h)\\
\eta(h) & \approx & \dfrac{\left(\frac{h}{4\,10^{-7}}\right)^{1.7}}{1+\left(\frac{h}{4\,10^{-7}}\right)^{1.7}} \approx 
        \dfrac
{
10^{1.7(6.39-\mathrm{pH})}
}
{
1+10^{1.7(6.39-\mathrm{pH})}
}\\
\end{array}
\right.
\end{equation}
...
\left\lbrace
	\begin{array}{rcl}
	g(t) & = & \kappa  h(t)  = \kappa  \left(  \proton_\infty + \left(\proton_0 - \proton_\infty\right) \dfrac{t_h}{t+t_h} \right)\\
	\\
	G(t) & = & \kappa \left( \proton_\infty t + \left(\proton_0 - \proton_\infty\right) t_h \ln\left(1+\dfrac{t}{t_h}\right)\right)\\
	\end{array}
\right.
\end{equation}
