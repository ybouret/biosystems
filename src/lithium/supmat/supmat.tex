...
For any $\mu$:
\begin{equation}
	r_0\sigma \leq \dfrac{1+\mu\gamma_h}{1+\left(\dfrac{1+\mu}{r_0\sigma}-1\right) \gamma_h} < r_\infty < 1.
\end{equation}
We define:
\begin{equation}
	r_\mu = \dfrac{1+\mu\gamma_h}{1+\left(\dfrac{1+\mu}{r_0\sigma}-1\right) \gamma_h}
\end{equation}
and we get the value
\begin{equation}
	\hat\alpha_\infty = \dfrac{\left(1-r_\infty\right)}
	{ \left(1-r_\infty\right) + 
	\left[1+\left(\dfrac{1+\mu}{r_0\sigma}-1\right) \gamma_h\right] \left(r_\infty-r_\mu\right)
	}
\end{equation}
