...
\begin{array}{rcl}
	...
	\Upsilon_\alpha & = & \epsilon_6 \Upsilon_6 + \epsilon_7 \Upsilon_7 = (\epsilon_6 \kappa + \epsilon_7) \Upsilon_7\\
\end{array}
\right.
\end{equation}
...
\begin{array}{rcl}
	...
	& = & s_0 \left[  (\epsilon_6 \sigma + \epsilon_7) k_7 \Theta \right] \LiAllOut,\\
\end{array}	
\end{equation}
so that
\begin{equation}
\label{eq:speedup}
	E_0 \proton_0 \Upsilon_\alpha = E_0 \proton_0 \left(\epsilon_6\kappa+\epsilon_7\right)\Upsilon_7 = (s_0-1) \left[  (\epsilon_6 \sigma + \epsilon_7) k_7 \Theta \right]
\end{equation}
...
\label{eq:mu_def}
	...
	\dfrac{ \left(\epsilon_6 \sigma + \epsilon_7\right) }{\left(\epsilon_6\kappa+\epsilon_7\right)}}_{\mu}.
\end{equation}
